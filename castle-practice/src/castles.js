...
export const CASTLES = [
  {
    id: 'mino',
    name: '美濃囲い',
    description: '振り飛車の代表的な囲い。玉を左端に素早く移動させ、金銀でコンパクトに守る。横からの攻めに強く、手数が少ないのが特徴。',
    requirements: [
  ...
  },
  {
    id: 'yagura',
    name: '矢倉',
    description: '居飛車の代表的な囲い。金銀が密集して縦の攻めに非常に強固。組み上げるのに手数がかかるが、完成すれば堅さは抜群。',
    requirements: [
  ...
  },
  {
    id: 'anaguma_right',
    name: '右穴熊',
    description: '玉を右端（1九）に潜り込ませ、金銀で固める最強クラスの堅陣。組み上げれば攻め合いで有利になりやすいが、端攻めには注意が必要。',
    requirements: [
